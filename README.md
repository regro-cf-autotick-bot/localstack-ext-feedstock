...
Once the `conda-forge` channel has been enabled, `localstack-ext` can be installed with:

```
conda install localstack-ext
```

It is possible to list all of the versions of `localstack-ext` available on your platform with:
